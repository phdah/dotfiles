...
vim.api.nvim_create_autocmd("FileType", {
    ...
    callback = function()
        ...
        vim.api.nvim_buf_set_keymap(0, 'n', 'A', '<Plug>(DBUI_AddConnection)',
                                    {noremap = true, silent = true})
        vim.api.nvim_buf_set_keymap(0, 'n', 'd', '<Plug>(DBUI_DeleteLine)',
                                    {noremap = true, silent = true})
        vim.api.nvim_buf_set_keymap(0, 'n', 'H', '<Plug>(DBUI_ToggleDetails)',
                                    {noremap = true, silent = true})
        vim.api.nvim_buf_set_keymap(0, 'n', 'R', '<Plug>(DBUI_Redraw)',
                                    {noremap = true, silent = true})
        vim.api.nvim_buf_set_keymap(0, 'n', 'r', '<Plug>(DBUI_RenameLine)',
                                    {noremap = true, silent = true})
        vim.api.nvim_buf_set_keymap(0, 'n', 'K', '<Plug>(DBUI_GotoPrevSibling)',
                                    {noremap = true, silent = true})
        vim.api.nvim_buf_set_keymap(0, 'n', 'J', '<Plug>(DBUI_GotoNextSibling)',
                                    {noremap = true, silent = true})
...
vim.api.nvim_create_autocmd("FileType", {
    ...
    callback = function()
        ...
        vim.api.nvim_buf_set_keymap(0, 'n', '<Leader>w',
                                    '<Plug>(DBUI_SaveQuery)',
                                    {noremap = true, silent = true})
        vim.api.nvim_buf_set_keymap(0, 'n', '<Leader>s',
                                    '<Plug>(DBUI_ExecuteQuery)',
                                    {noremap = true, silent = true})
        vim.api.nvim_buf_set_keymap(0, 'v', '<Leader>s',
                                    '<Plug>(DBUI_ExecuteQuery)',
                                    {noremap = true, silent = true})
        vim.api.nvim_buf_set_keymap(0, 'n', '<Leader>r',

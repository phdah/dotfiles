...
vim.api.nvim_set_keymap('n', '<C-Right>', '<Nop>',
                        {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<C-Left>', '<Nop>',
                        {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<C-Up>', '<Nop>', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<C-Down>', '<Nop>',
                        {noremap = true, silent = true})
...
vim.api
    .nvim_set_keymap('v', '<Right>', '<Nop>', {noremap = true, silent = true})
vim.api.nvim_set_keymap('v', '<C-Right>', '<Nop>',
                        {noremap = true, silent = true})
vim.api.nvim_set_keymap('v', '<C-Left>', '<Nop>',
                        {noremap = true, silent = true})
vim.api.nvim_set_keymap('v', '<C-Up>', '<Nop>', {noremap = true, silent = true})
vim.api.nvim_set_keymap('v', '<C-Down>', '<Nop>',
                        {noremap = true, silent = true})
...
vim.api
    .nvim_set_keymap('i', '<Right>', '<Nop>', {noremap = true, silent = true})
vim.api.nvim_set_keymap('i', '<C-Right>', '<Nop>',
                        {noremap = true, silent = true})
vim.api.nvim_set_keymap('i', '<C-Left>', '<Nop>',
                        {noremap = true, silent = true})
vim.api.nvim_set_keymap('i', '<C-Up>', '<Nop>', {noremap = true, silent = true})
vim.api.nvim_set_keymap('i', '<C-Down>', '<Nop>',
                        {noremap = true, silent = true})
...
-- Keybind terminal
vim.api.nvim_set_keymap('t', '<C-k>', [[<C-\><C-n>]],
                        {noremap = true, silent = true})

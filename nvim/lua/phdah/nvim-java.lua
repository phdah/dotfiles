-- Guide comes from: https://github.com/bcampolo/nvim-starter-kit/blob/java/.config/nvim/ftplugin/java.lua
...
vim.list_extend(bundles, vim.split(vim.fn.glob(vim.env.HOME ..
                                                   "/.local/share/nvim/mason/share/java-test/*.jar",
                                               1), "\n"))
...
local config = {
    ...
    cmd = {
        ...
        '-javaagent:' .. vim.env.HOME ..
            '/.local/share/nvim/mason/share/jdtls/lombok.jar', '-Xmx4g',
    ...
    settings = {
        java = {
            ...
            home = '/opt/avinode/jdk-17.0.9_9/Contents/Home',
            ...
            configuration = {
                ...
                runtimes = {
                    {
                        name = "JavaSE-11",
                        path = "/opt/avinode/jdk-11.0.8_10/Contents/Home"
                    },
                    {
                        name = "JavaSE-17",
                        path = "/opt/avinode/jdk-17.0.9_9/Contents/Home"
                    }
                }
            },
